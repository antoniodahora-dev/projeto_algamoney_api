...
public class LancamentoResource {
	...
	//metodo para realizar o envio de um arquivo para o desktop
	@PostMapping("/anexo")
	@PreAuthorize("hasAuthority('ROLE_CADASTRAR_LANCAMENTO') and #oauth2.hasScope('write')") 
	public Anexo uploadAnexo(@RequestParam MultipartFile anexo) throws IOException {
		
		/*OutputStream out = new FileOutputStream(
				"/home/antonio/Documentos/axeno--" + anexo.getOriginalFilename());
		...
		//ira retorna o anexo mais a url configurada
		return new Anexo(nome, s3.configurarUrl(nome));
	}
	
	

	//metodo ira gerar o grafico para front-end a partir do caminho
	@GetMapping("/estatisticas/por-dia")
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and #oauth2.hasScope('read')")
	public List<LancamentoEstatisticaDia> porDia() {
		return this.lancamentoRepository.porDia(LocalDate.now()); //.withMonth(11)-realiza a pesquisa por um mês especifico ao acrescenta na funcao
	}
	...
	public List<LancamentoEstatisticaCategoria> porCategoria() {
		return this.lancamentoRepository.porCategoria(LocalDate.now()); //.withMonth(11)-realiza a pesquisa por um mês especifico ao acrescenta na funcao

	}
	
	//metodo que ira enviar as informaçoes para o jaspersoft
